namespace OffEE
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "Form1";
			this.Text = "EE Off (Offline EE) - by ninjasupeatsninja";
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.FormIsClosing);
			this.Load += new System.EventHandler(this.Form1_Load);
			this.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.WhenAKeyIsPressed);
